package cn.cxnxs.common.api.system;

import cn.cxnxs.common.api.system.domain.UserApiEntity;
import cn.cxnxs.common.api.system.factory.SystemServiceFallbackFactory;
 ...
 * @author mengjinyuan
 */
@FeignClient(value = "system", fallbackFactory = SystemServiceFallbackFactory.class)
